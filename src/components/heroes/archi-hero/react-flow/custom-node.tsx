...
import { Box, BoxProps, Stack, styled, SvgIcon, SvgIconProps } from '@mui/material'
import React, { forwardRef, ForwardRefExoticComponent, FunctionComponent, ReactNode } from 'react'
...
const BaseNode: ForwardRefExoticComponent<BaseNodeProps> = forwardRef(({ children, ...props }, ref) => (
  <Box ref={ref} {...props}>
    {children}
  </Box>
))
